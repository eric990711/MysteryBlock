...
#if !UNITY_EDITOR && (UNITY_IOS || UNITY_ANDROID || UNITY_WP8 || UNITY_BLACKBERRY)
#define MOBILE
#endif
	...
	bool ProcessEvent (Event ev)
	{
		...
		switch (ev.keyCode)
		{
			...
			case KeyCode.KeypadEnter:
			{
				...
				{
					char c = '\n';
					if (onValidate != null) c = onValidate(mEditor.text, mEditor.cursorIndex, c);
					else if (validation != Validation.None) c = Validate(mEditor.text, mEditor.cursorIndex, c);
