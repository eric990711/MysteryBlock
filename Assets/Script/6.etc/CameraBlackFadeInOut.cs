...
[AddComponentMenu("JI/Camera/Fade/Black fade")]
public class CameraBlackFadeInOut : MonoBehaviour {
    ...
    public Texture2D fadeTextureBlack = null;
    ...
    public static CameraBlackFadeInOut GetInstance()
    {
        // Get Script
        CameraBlackFadeInOut fader = (CameraBlackFadeInOut)Camera.main.GetComponent("CameraBlackFadeInOut");
